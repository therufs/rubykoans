...
class AboutClassMethods < Neo::Koan
  ...
  def test_class_methods_are_independent_of_instance_methods
    fido = Dog2.new
    assert_equal :instance_level_wag, fido.wag  ## wat!
    assert_equal :class_level_wag, Dog2.wag
  end
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal nil, Dog.name  ## Accessors only work on instances
  end
  ...
  def test_you_can_define_class_methods_inside_the_class ## WHY
  ...
  def test_self_while_inside_class_is_class_object_not_instance ## important
  ...
  def test_heres_still_another_way_to_write_class_methods
    assert_equal :still_another_way, Dog.another_class_method  ## SRSLY WHY
  end
