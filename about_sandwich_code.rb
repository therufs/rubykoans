...
class AboutSandwichCode < Neo::Koan
  ...
  def count_lines2(file_name)
    file_sandwich(file_name) do |file| ## oooooohhhh
      count = 0
      while file.gets
        count += 1
      end
  ...
  def count_lines3(file_name)  ## where is the sandwich?
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block ## oh, open makes it (?)
