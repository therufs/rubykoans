...
class AboutSymbols < Neo::Koan
  ...
  ## Ruby symbolifies everything (when you ask about a symbol existing, it starts to exist.)
  ...
  ## Because ..... you've already used up the memory the strings occupy by making the strings? 
end
